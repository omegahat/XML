...
nn = newXMLNode("omg:x", namespaceDefinitions = c(omg = "http://www.omegahat.org"))
nn = newXMLNode("omg:x", namespaceDefinitions = c(omg = "http://www.omegahat.org",
                                                   r = 'http://www.r-project.org'))

svg = newXMLNode("svg", namespaceDefinitions =  c(omg = "http://www.omegahat.org"))

svg = newXMLNode("omg:svg", namespaceDefinitions =  c(omg = "http://www.omegahat.org"))
svg = newXMLNode("no:svg", namespaceDefinitions =  c(omg = "http://www.omegahat.org"))
